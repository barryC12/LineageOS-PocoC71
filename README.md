# LineageOS 22.2 — Poco C71 Bootloader Unlock & Flash Guide
...
## Step 4 — Flash LineageOS 22.2

Download whichever build you want:

- **With GApps:** [`LineageOS-22.2-20260105-GAPPS-EXT4-GSI.7z`](https://sourceforge.net/projects/misterztr-gsi/files/LineageOS/Android%2015/LineageOS-22.2-20260105-GAPPS-EXT4-GSI.7z/download)
- **Vanilla (no GApps):** [`LineageOS-22.2-20260105-VANILLA-EXT4-GSI.7z`](https://sourceforge.net/projects/misterztr-gsi/files/LineageOS/Android%2015/LineageOS-22.2-20260105-VANILLA-EXT4-GSI.7z/download)
...
```
.\fastboot flash system LineageOS-22.2-20260105-GAPPS-EXT4-GSI.img
```
...
> copy all the lines after mkdir -p /data/adb/service.d at once and paste them as one command
...
| LineageOS 22.2 (GApps)        | [sourceforge.net](https://sourceforge.net/projects/misterztr-gsi/files/LineageOS/Android%2015/LineageOS-22.2-20260105-GAPPS-EXT4-GSI.7z/download)                       |
| LineageOS 22.2 (Vanilla)      | [sourceforge.net](https://sourceforge.net/projects/misterztr-gsi/files/LineageOS/Android%2015/LineageOS-22.2-20260105-VANILLA-EXT4-GSI.7z/download)                     |
...
- **[TomKing062](https://github.com/TomKing062)** — for the CVE-2022-38694 bootloader unlock tool that makes this whole process possible
- **SPD Driver maintainers** — for the Unisoc/SPD USB driver used during the unlock process
- **[LineageOS](https://lineageos.org/)** — for the incredible work on LineageOS in general, keeping older and budget devices alive with modern Android
- **[misterztr](https://sourceforge.net/projects/misterztr-gsi/)** — for building and maintaining the LineageOS 22.2 GSI used in this guide

---

## Final Note

Once you go through all of this — the bootloader unlock, flashing LineageOS 22.2, rooting, the swap file, EX Kernel Manager, and killing the animations — the Poco C71 genuinely turns into a beast. For a phone that costs under $100, you end up with a smooth, debloated, up-to-date Android 16 experience that punches way above its price tag. Well worth the effort.
